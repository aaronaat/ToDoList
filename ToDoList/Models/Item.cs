...
namespace ToDoList.Models
{
  public class Item
  {
    ...
    public Item (string description, int id = 0, int complete = 0)
    {
    ...
    public static List<Item> GetAll()
    {
      ...
      while(rdr.Read())
      {
        ...
        int itemComplete = rdr.GetInt32(2);
        Item newItem = new Item(itemDescription, itemId, itemComplete);
    ...
    public static Item Find(int id)
    {
      ...
      while(rdr.Read())
      {
        ...
        itemComplete = rdr.GetInt32(2);
      }
      Item newItem = new Item(itemName, itemId, itemComplete);
      conn.Close();
      if (conn != null)
      {
        conn.Dispose();
    ...
    public void Save()
    {
      ...
      conn.Open();
      var cmd = conn.CreateCommand() as MySqlCommand;
      cmd.CommandText = @"INSERT INTO items (description, complete) VALUES (@description, @complete);";
      ...
      complete.ParameterName = "@complete";
